/******************************************************************************
Um compressor, programa que lê uma imagem e imprime números que representam a
imagem compactamente. A compressão mudará a imagem, mas apenas de modos quase
imperceptíveis. A saída consiste na impressão de números representantes da imagem 
codificada.
******************************************************************************/
#include <stdio.h>
#include <stdlib.h>
